...
const Body = () => {
  return (
    <Flex /* height="2000px" */ p={10} align="center" justify="space-between" flexDirection="column" gap={[5, 10]}>
      ...
      <Flex flexDirection="column" width={["95%", "80%"]} gap={[5, 10]} p={[5, 10]} mt={[2, 4]}>
        <Flex flexDirection="column" gap={[3, 5]} align="center" justify="space-around">
          <Text fontWeight="bold" fontSize={["2xl", "4xl"]} color="black">Le Calculateur d'Empreinte Carbone d'EFREI Paris</Text>
          <Text fontWeight="bold" fontSize={["sm", "md"]} color="black">
            Dotée d’un réseau largement ouvert sur le monde, l'école EFREI Paris a la capacité de rayonner sur l’ensemble des continents et de proposer des mobilités universitaires internationales dans 93 prestigieuses institutions partenaires dans 40 pays.
          </Text>
          <Text fontWeight="bold" fontSize={["sm", "md"]} color="black">
          La mobilité internationale est obligatoire dans le cadre du programme Ingénieur de l’Efrei. Les élèves ingénieur sous statut étudiant ont l’obligation d’effectuer deux périodes de mobilité à l’international, dont une période d’un semestre. Les élèves ingénieur en filière apprentissage doivent effectuer une mobilité à l’international.
          </Text>
        </Flex>

        <Flex align="center" justify="space-between" flexDirection={["column", "row"]} mt={5} border="4px" borderColor="#0C2340" borderStyle="dashed" p={[5, 10]}>
          <Flex align="center" justify="space-between" flexDirection="column">
            <Text fontWeight="bold" fontSize={["xl", "2xl"]} color="black">Connaissez-vous votre empreinte carbon liée à la mobilité ?</Text>
            <Text fontWeight="bold" fontSize={["xs", "sm"]} color="black">
              Remplir le questionnaire et découvrez comment réduire votre empreinte carbone sur le climat.
            </Text>
          </Flex>
          <Link as={RouterLink} to="/questionnaire">
            <Button size="md" height="48px" width={["full", "200px"]} border="2px" borderColor="#0C2340" fontSize={["sm", "md"]} justifyContent="space-between">
              Calculer <Icon as={MdKeyboardArrowRight} color="#0C2340" w={10} h={8} />
            </Button>
          </Link>
        </Flex>
      </Flex>

      <Flex width={["95%", "90%"]} height={["360px", "480px"]}>
        <iframe
            src="https://www.google.com/maps/d/embed?mid=14Srngj75VBAmMrIY6QAcIOuo2laUwLJc&ehbc=2E312F"
            width="100%"
            height="100%"
